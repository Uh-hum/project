...
export default {
    ...
    methods: {
        // 将请求封装为函数，在需要调用的时候直接调用该函数即可向服务器请求数据
        getData() {
            this.$store.dispatch("getSearchInfo", this.searchParams);
        },
        removeCategoryName() {
            // 删除筛选条件，重置参数的同时发送请求
            // 属性设置为 undefined 的时候就无需放在请求中带给服务器
    ...
    watch: {
        $route() {
            ...
            this.getData();
            // 每一次请求完毕，应该把相应的1、2、3级分类的id置空，让他接收下一次的参数
            this.searchParams.category1Id = undefined;
            this.searchParams.category2Id = undefined;
            this.searchParams.category3Id = undefined;
        }
